...
namespace BLL.HolidayRental.Entities
{
    public class Echange
    {
        ...
        public Echange(int IdEchange, int NumeroReservation, DateTime DateReservation, DateTime DateEntree, DateTime DateSortie, DateTime DateReglement, string MoyenPaiement, string StatusEchange)
        {
            idEchange = IdEchange;
